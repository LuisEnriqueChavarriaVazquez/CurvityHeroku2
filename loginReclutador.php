        ...
        <form class="col s12" method="POST" action="loginReclutador.php">
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <input id="email" name="entradaReclutador" id="entradaReclutador" type="email" class="validate white-text">
            ...
            <input type="submit" name="submit"  class="waves-effect btn-large borderButton sizeButton textButton grey lighten-5 blue-text text-darken-4" value="Iniciar Sesión"></p>
           <?php
